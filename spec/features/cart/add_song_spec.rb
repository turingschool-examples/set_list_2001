...
RSpec.describe 'When a user adds songs to their cart' do
  ...
  it 'increments properly for more than one song' do
    artist = Artist.create(name: 'Rick Astley')
    song_1 = artist.songs.create(title: 'Never gonna give you up',
                                 length: 250,
                                 play_count: 12345)
  ...
  it 'displays total number of songs in the cart' do
    artist = Artist.create(name: 'Rick Astley')
